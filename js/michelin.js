...
exports.get = function() {
  ...
  .then(function(results){
    jsonfile.writeFile('liste_restaurants.json', results, {spaces: 2}, function(err){
      if(err){
        console.error(err);
      }
...
exports.getAllAddresses = function(restaurants) {
  ...
  .then(function(restaurants){
    jsonfile.writeFile('liste_adresses_restaurants.json', restaurants, {spaces: 2}, function(err){
      if(err){
        console.error(err);
      }
      console.log('***** json done *****');
